...
void UOnlineSessionsSubsystem::OnCreateGameSessionComplete(FName SessionName, bool bSucceeded)
{
	...
	GEngine->AddOnScreenDebugMessage(-1, 5.f, FColor::Blue, TEXT("OnlineSessionSubsystem Server Traveling"));
	GetWorld()->ServerTravel("/Game/MAPS/TestMap_1"); // For easier testing
}
