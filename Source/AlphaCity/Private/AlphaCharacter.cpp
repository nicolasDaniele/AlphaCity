...
{
	// Call here the PlayerController logic to travel?
}

void AAlphaCharacter::TestFunction(const FString& LevelToTravel)
{
	//Server_TestFunction(LevelToTravel);
	//Client_TestFunction(LevelToTravel);
	BlueprintTestFunction(LevelToTravel);
}

void AAlphaCharacter::Server_TestFunction_Implementation(const FString& LevelToTravel)
{
	Client_TestFunction(LevelToTravel);
}

void AAlphaCharacter::Client_TestFunction_Implementation(const FString& LevelToTravel)
{
	if (AAlphaPlayerController* alphaPC = Cast<AAlphaPlayerController>(GetController()))
	{
