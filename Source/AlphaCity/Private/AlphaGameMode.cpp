...
void AAlphaGameMode::OnPostLogin(AController* NewPlayer)
{
	...
	onlineSubsystem->OnPlayerConnected(NewPlayer);
}

void AAlphaGameMode::Logout(AController* Exiting)
{
	...
	onlineSubsystem->OnPlayerDisconnected(Exiting);
}